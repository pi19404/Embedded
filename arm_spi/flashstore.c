...
//            //
//            if(pRecord->ulSeconds==99 && ulOldestSeconds==0xFFFFFFFF)
//            {
...
////
////*****************************************************************************
//int FlashStoreOpenLogFile(unsigned long ulStartAddr)
//{
//
//	if(!USBStickOpenLogFile(0)) return(1);
//    unsigned long ulAddr;
//
//    //
...
//    //
//    //snprintf(cBufFree, sizeof(cBufFree), "FREE: %3uK", ulFreeBlocks);
//    //snprintf(cBufUsed, sizeof(cBufUsed), "USED: %3uK", ulUsedBlocks);
